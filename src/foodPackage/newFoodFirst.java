...
public class newFoodFirst implements newFood {
	...
	public newFoodFirst() {
		...
		// Autogenerate menu 
		newMenu meny1 = new newMenu("Crispy fried chicken with Potato smash and Vanilla Fruit icecream",5.00); 
		newMenu meny2 = new newMenu("Steam Fish Fillet with Garlic sauce and Strawberry smoothie",6.50);
		newMenu meny3 = new newMenu("Beef Burrito with Lemon Tart",7.00);
